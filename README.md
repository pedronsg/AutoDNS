...
- Go 1.21+
- [Orbit Studio VS Code extension](https://www.orbit-os.org/downloads.html)
- Python 3 (used by the build script)
- An OrbitOS device reachable on the network

> **gRPC certificates:** The Orbit Studio extension handles the installation of the gRPC certificates required to communicate with the device. Make sure to install them through the extension before running the app.
