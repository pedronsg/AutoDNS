...
//
//	-X github.com/OrbitOS-org/sdk-go/v26/metadata.EntryPoint=basic
//	-X github.com/OrbitOS-org/sdk-go/v26/metadata.PackageType=binary
//	-X github.com/OrbitOS-org/sdk-go/v26/metadata.BuildArch=arm64
//
// build_package.sh / CI set these; users must not invent type/entry point in metadata.json.
//
//	go build -ldflags "-X github.com/OrbitOS-org/sdk-go/v26/metadata.EntryPoint=basic -X github.com/OrbitOS-org/sdk-go/v26/metadata.BuildArch=arm64 ..." ./cmd/examples/basic
package metadata
...
var (
	BuildDate   = "unknown"
	GitCommit   = "unknown"
	EntryPoint  = ""       // -X github.com/OrbitOS-org/sdk-go/v26/metadata.EntryPoint=<binary basename>
	PackageType = "binary" // -X github.com/OrbitOS-org/sdk-go/v26/metadata.PackageType=… (default binary)
	BuildArch   = ""       // -X github.com/OrbitOS-org/sdk-go/v26/metadata.BuildArch=<goarch> (e.g. arm64)
)
