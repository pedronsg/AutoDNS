...
func (s *SystemManager) Attach() (bool, error) {
	resp, err := s.client.Attach(s.ctx, &types.Empty{})
	if err != nil {
		return false, err
	}
	if err := rpcError(resp.GetError()); err != nil {
...
func (s *SystemManager) EnableDevMode() (bool, error) {
	resp, err := s.client.EnableDeveMode(s.ctx, &types.Empty{})
	if err != nil {
		return false, err
	}
	if err := rpcError(resp.GetError()); err != nil {
...
func (s *SystemManager) DisableDevMode() (bool, error) {
	resp, err := s.client.DisableDevMode(s.ctx, &types.Empty{})
	if err != nil {
		return false, err
	}
	if err := rpcError(resp.GetError()); err != nil {
...
func (s *SystemManager) IsDevModeEnabled() (bool, error) {
	resp, err := s.client.IsDevModeEnabled(s.ctx, &types.Empty{})
	if err != nil {
		return false, err
	}
	if err := rpcError(resp.GetError()); err != nil {
...
func (s *SystemManager) EnableSSHServer() (bool, error) {
	resp, err := s.client.EnableSSHServer(s.ctx, &types.Empty{})
	if err != nil {
		return false, err
	}
	if err := rpcError(resp.GetError()); err != nil {
...
func (s *SystemManager) DisableSSHServer() (bool, error) {
	resp, err := s.client.DisableSSHServer(s.ctx, &types.Empty{})
	if err != nil {
		return false, err
	}
	if err := rpcError(resp.GetError()); err != nil {
...
func (s *SystemManager) IsSSHServerEnabled() (bool, error) {
	resp, err := s.client.IsSSHServerEnabled(s.ctx, &types.Empty{})
	if err != nil {
		return false, err
	}
	if err := rpcError(resp.GetError()); err != nil {
...
func (s *SystemManager) EnableRebootOnFailure() (bool, error) {
	resp, err := s.client.EnableRebootOnFailure(s.ctx, &types.Empty{})
	if err != nil {
		return false, err
	}
	if err := rpcError(resp.GetError()); err != nil {
...
func (s *SystemManager) DisableRebootOnFailure() (bool, error) {
	resp, err := s.client.DisableRebootOnFailure(s.ctx, &types.Empty{})
	if err != nil {
		return false, err
	}
	if err := rpcError(resp.GetError()); err != nil {
...
func (s *SystemManager) IsRebootOnFailureEnabled() (bool, error) {
	resp, err := s.client.IsRebootOnFailureEnabled(s.ctx, &types.Empty{})
	if err != nil {
		return false, err
	}
	if err := rpcError(resp.GetError()); err != nil {
...
func (s *SystemManager) AllowUntrustedApps() (bool, error) {
	resp, err := s.client.AllowUntrustedApps(s.ctx, &types.Empty{})
	if err != nil {
		return false, err
	}
	if err := rpcError(resp.GetError()); err != nil {
...
func (s *SystemManager) DisallowUntrustedApps() (bool, error) {
	resp, err := s.client.DisallowUntrustedApps(s.ctx, &types.Empty{})
	if err != nil {
		return false, err
	}
	if err := rpcError(resp.GetError()); err != nil {
...
func (s *SystemManager) IsUntrustedAppsAllowed() (bool, error) {
	resp, err := s.client.IsUntrustedAppsAllowed(s.ctx, &types.Empty{})
	if err != nil {
		return false, err
	}
	if err := rpcError(resp.GetError()); err != nil {
