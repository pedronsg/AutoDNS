...
func (v *VPNManager) WatchEvents(ctx context.Context, profileID string, handler func(*vpnv26.VPNEvent)) error {
	stream, err := v.client.WatchEvents(ctx, &vpnv26.WatchEventsRequest{ProfileId: profileID})
	if err != nil {
